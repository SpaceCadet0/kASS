import svgPaths from "./svg-2ne1v20uh3";
type Component4Props = {
  className?: string;
  property1?: "Rectangle 221";
};

function Component4({ className, property1 = "Rectangle 221" }: Component4Props) {
  return (
  ...
  return (
    <div className="absolute left-[26px] size-[24px] top-[855px]" data-name="settings">
      <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 24 24" width="24">
        <g clipPath="url(#clip0_0_102)" id="settings">
...
function InputField() {
  return (
    <div className="bg-[#f9f9f9] content-stretch flex gap-[10px] items-center justify-end px-[16px] py-[18px] relative rounded-[10px] shrink-0 w-[507px]" data-name="Input field">
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Raleway:Regular',sans-serif] font-normal justify-end leading-[0] min-w-px opacity-50 relative text-[#252422] text-[16px]">
        <p className="leading-[1.25]">Выберите категорию</p>
      </div>
...
function InputField3() {
  return (
    <div className="bg-[#47d465] content-stretch flex gap-[10px] h-[40px] items-center px-[16px] py-[18px] relative rounded-[10px] shrink-0" data-name="Input field">
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[35px] top-[84.26px] w-[507px]">
      <Input />
      <Input1 />
      <Input2 />
      <Input3 />
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex gap-[18px] items-center left-[37px] top-[768px]">
      <Component4 className="relative shrink-0 size-[20px]" />
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[29px] top-[34px] w-[583px]">
      <Input6 />
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex gap-[13px] items-center left-[29px] top-[144px] w-[583px]">
      <ButtonPrimary1 />
      <ButtonPrimary2 />
    </div>
  );
...
function Component2() {
  return (
    <div className="absolute bg-white h-[822px] left-[753px] rounded-[10px] top-[85px] w-[628px]" data-name="Данные пользоват">
      <Frame8 />
      <Frame10 />
      <ButtonPrimary3 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Raleway:Regular',sans-serif] font-normal leading-[1.2] left-[68px] text-[#f07528] text-[14px] text-center top-[258px] whitespace-nowrap" style={{ fontFeatureSettings: '"lnum" 1, "pnum" 1' }}>
        Нет данных
      </p>
    </div>
  );
...
function Component3() {
  return (
    <div className="absolute contents left-[782px] top-[311px]" data-name="Ист опер">
      <div className="-translate-y-full [word-break:break-word] absolute flex flex-col font-['Raleway:Regular',sans-serif] font-normal h-[23px] justify-end leading-[0] left-[782px] text-[#252422] text-[16px] top-[334px] w-[340px]" style={{ fontFeatureSettings: '"lnum" 1, "pnum" 1' }}>
...
export default function Component() {
  return (
    <div className="bg-[#f6f6f6] relative size-full" data-name="Регистрация гостя">
