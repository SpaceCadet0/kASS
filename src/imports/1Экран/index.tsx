...
function InputField1() {
  return <div className="bg-[#f9f9f9] content-stretch flex h-[56px] items-center px-[16px] py-[18px] relative rounded-[10px] shrink-0 w-[392px]" data-name="Input field" />;
}
...
export default function Component1() {
  return (
    <div className="bg-[#f6f6f6] relative size-full" data-name="1 экран">
      <Frame2 />
      <Component />
      <Component2 />
    </div>
